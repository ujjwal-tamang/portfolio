...
const fallbackInsights: InsightArticle[] = [
  {
    id: "ins-1",
...
export const CybersecurityInsightsSection: React.FC = () => {
  ...
  // Always use static data for the frontend portfolio display
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 space-y-3">
          ...
          <p className="text-zinc-400 text-xs sm:text-base leading-relaxed">
            Live threat intelligence digest and zero-day advisories compiled with Ujjwal Tamang's expert SOC analyst commentary.
          </p>
        </div>
